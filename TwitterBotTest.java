...
public class TwitterBotTest {
    ...
    public void testWithDuplicates() {
        ...
        String words = "0, The the end end should should come here here.\n"
                + "1, This this comes from from from data data with duplicate words words!";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);
        t.fixDistribution(desiredTweet);
    ...
    @Test
    public void testNumWordsGreaterThanIteratorLength() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "this", "comes", "from", "data", "with", "no", "duplicate", "words", ".",
                        "the", "end", "should", "come", "."
